      ...
      <div class="py-3">
        <div class="row">
          ...
          <div class="col-lg-7" data-aos="zoom-in" data-aos-duration="1500">
            <div class="my-lg-4">
              <h2 class="fw-bold mb-5 text-white text-legend">Yang Bisa Kami Berikan</h2>
              <div class="row">
                  <div class="col-md-4 mb-3">
                      <div class="d-flex flex-column gap-2 bg-white p-3 rounded-2 w-100">
                        
                          <div class="mx-auto">
                            <i class="bi bi-play-circle-fill text-orange fs-1"></i>
                          </div>
                          <div class="benefit-content">
                            <h6 class="text-first text-legend text-center">Video Learning</h6>
                ...
                <div class="col-md-4 mb-3">
                      <div class="d-flex flex-column gap-2 bg-white p-3 rounded-2 w-100">
                          ...
                          <div class="benefit-content">
                            <h6 class="text-first text-legend text-center">Akses Tiap Saat</h6>
                ...
                <div class="col-md-4 mb-3">
                      <div class="d-flex flex-column gap-2 bg-white p-3 rounded-2 w-100">
                          ...
                          <div class="benefit-content">
                            <h6 class="text-first text-legend text-center">Mentoring</h6>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="card-testimoni mb-3">
                <div class="card-header p-4 bg-white border rounded-top">
                  <div class="d-flex">
                    <div class="w-25">
                      <img class="image-testimoni rounded-circle" height="70" src="<?= base_url('assets/images/admin/testimony/' . $item->image) ?>" alt="">
                    </div>
