                        ...
                        <div class="py-3">
                            ...
                            <div class="py-2">
                                 <select class="form-select" aria-label="Default select example" id="my-select">
                                  <option value="<?= site_url('userBranch/classpath/listClass') ?>" <?php if ($this->uri->segment(3) === "listClass") {
                                                                                            echo "selected";
                                                                                        } ?>>Terbaru - Terlama</option>
                                  <option value="<?= site_url('userBranch/classpath/listClassAsc') ?>"  <?php if ($this->uri->segment(3) === "listClassAsc") {
                                                                                            echo "selected";
                                                                                        } ?>>Terlama - Terbaru</option>
                                  <option value="<?= site_url('userBranch/classpath/listClassAZ') ?>" <?php if ($this->uri->segment(3) === "listClassAZ") {
                                                                                            echo "selected";
                                                                                        } ?>>A - Z</option>
                                  <option value="<?= site_url('userBranch/classpath/listClassZA') ?>" <?php if ($this->uri->segment(3) === "listClassZA") {
                                                                                            echo "selected";
                                                                                        } ?>>Z - A</option>
                                </select>
                            </div>
                                        ...
                                        <div class="class-image">
                                            ...
                                            <?php if ($data->has_relation) : ?>
                                                <div class="like-bottom my-auto mt-auto">
                                                    <i class="position-absolute bx bxs-bookmark like_icon bg-white border text-warning bg-danger">
                                                    </i>
                                                </div>
                                            <?php else : ?>
